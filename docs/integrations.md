...
- O botão **Iniciar piloto de 5 dias** abre o feed e ativa Jev e DRY RUN juntos. Ao pausar, o processo fecha o feed e cancela uma ordem virtual pendente, mas o prazo de cinco dias continua correndo. O serviço fica ocioso depois de iniciar o container. Amostras/eventos/observações de mercado são mantidos por até 30 dias; o ledger simulado permanece separado e é persistido por rede/mercado.
