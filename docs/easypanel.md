...
- `bot`: worker de leitura Kuru/Monad e DRY RUN local para o piloto. Fica ocioso até o operador iniciar o piloto; o botão liga monitor, Jev e simulador em conjunto.
