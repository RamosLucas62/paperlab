...
- **Integração externa ainda precisa ser configurada na VPS:** o modo mainnet somente leitura tem um endereço MON/USDC verificado e documentado em [EasyPanel](docs/easypanel.md); a testnet precisa de seu próprio mercado. A chave OpenRouter não foi configurada. As chamadas Jev podem ter custo e respeitam os limites de orçamento configurados.
